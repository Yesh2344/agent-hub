...
- Post in [GitHub Discussions](https://github.com/msitarzewski/agent-hub/discussions)
...
Want agent-hub to install into a new tool (a CLI, editor, or agent runtime)? First, **[open a Discussion](https://github.com/msitarzewski/agent-hub/discussions)** — new integration platforms are a "discuss first" change (see the PR Process below). Once there's alignment, a clean integration is small — usually **~5 files, never the converted output itself.** The just-merged Mistral Vibe integration is a good worked example to copy.
...
We love ambitious ideas — a [Discussion](https://github.com/msitarzewski/agent-hub/discussions) just gives the community a chance to align on approach before code gets written. It saves everyone time, especially yours.
...
- **General Questions**: [GitHub Discussions](https://github.com/msitarzewski/agent-hub/discussions)
- **Bug Reports**: [GitHub Issues](https://github.com/msitarzewski/agent-hub/issues)
- **Feature Requests**: [GitHub Issues](https://github.com/msitarzewski/agent-hub/issues)
- **Community Chat**: [Join our discussions](https://github.com/msitarzewski/agent-hub/discussions)
...
[Open an Issue](https://github.com/msitarzewski/agent-hub/issues) • [Start a Discussion](https://github.com/msitarzewski/agent-hub/discussions) • [Submit a PR](https://github.com/msitarzewski/agent-hub/pulls)
