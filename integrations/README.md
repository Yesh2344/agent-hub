...
```bash
cd /your/project && /path/to/agent-hub/scripts/install.sh --tool opencode
```
...
```bash
cd /your/project && /path/to/agent-hub/scripts/install.sh --tool cursor
```
...
```bash
cd /your/project && /path/to/agent-hub/scripts/install.sh --tool aider
```
...
```bash
cd /your/project && /path/to/agent-hub/scripts/install.sh --tool windsurf
```
...
```bash
cd /your/project && /path/to/agent-hub/scripts/install.sh --tool qwen
```
